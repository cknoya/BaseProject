...
public class NetworkChangeReceiver extends BroadcastReceiver {
    ...
    // 主动查询间隔时长
    private static final long RETRIEVE_STEP = 60 * 1000L;
     ...
     * 注册callback到receiver中
     */
    public void registReceiver(String tag, AbsNetworkChangeCallback callback, boolean needRetrieveBySelf) {
        registerNetworkChangObserver(tag, callback, needRetrieveBySelf);
    }
