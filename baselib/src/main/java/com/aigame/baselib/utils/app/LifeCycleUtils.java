...
public final class LifeCycleUtils {
    ...
    public static void init(@NonNull final Application app) {
        if (sApplication == null) {
            ...
            LifeCycleUtils.sApplication.registerActivityLifecycleCallbacks(ACTIVITY_LIFECYCLE);
        }
    }
    ...
    static Context getTopActivityOrApp() {
        if (isAppForeground()) {
            ...
            return topActivity == null ? LifeCycleUtils.getApp() : topActivity;
        } else {
            return LifeCycleUtils.getApp();
        }
    }
    ...
    static boolean isAppForeground() {
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(LifeCycleUtils.getApp().getPackageName());
            }
        }
        return false;
    }
