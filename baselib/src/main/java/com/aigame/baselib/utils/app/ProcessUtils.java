...
public final class ProcessUtils {
    ...
    public static boolean isMainProcess() {
        return LifeCycleUtils.getApp().getPackageName().equals(getCurrentProcessName());
    }
    ...
    public static String getCurrentProcessName() {
        ActivityManager am = (ActivityManager) LifeCycleUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am == null) {
            return null;
        }
        List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
