package com.aigame.baselib.utils.app;
...
import com.aigame.baselib.utils.ShellUtils;
...
public final class AppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final LifeCycleUtils.OnAppStatusChangedListener listener) {
        LifeCycleUtils.getActivityLifecycle().addListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        LifeCycleUtils.getActivityLifecycle().removeListener(obj);
    }
    ...
    public static void installApp(final File file) {
        ...
        LifeCycleUtils.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        LifeCycleUtils.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        return !isSpace(packageName)
                && LifeCycleUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName) != null;
    }
    ...
    public static boolean isAppInstalled(@NonNull final String action,
        ...
        PackageManager pm = LifeCycleUtils.getApp().getPackageManager();
    ...
    public static boolean isAppDebug() {
        return isAppDebug(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return LifeCycleUtils.isAppForeground();
    }
    ...
    public static void launchApp(final String packageName) {
        ...
        LifeCycleUtils.getApp().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp() {
        PackageManager packageManager = LifeCycleUtils.getApp().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(LifeCycleUtils.getApp().getPackageName());
        if (intent == null) {
            return;
        }
        ComponentName componentName = intent.getComponent();
        Intent mainIntent = Intent.makeRestartActivityTask(componentName);
        LifeCycleUtils.getApp().startActivity(mainIntent);
        System.exit(0);
    }
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        LifeCycleUtils.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = LifeCycleUtils.getActivityList();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return LifeCycleUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(LifeCycleUtils.getApp(), authority, file);
        }
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = LifeCycleUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
        if (intent == null) {
            return null;
        }
        return isNewTask ? intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK) : intent;
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) LifeCycleUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am == null) {
            return null;
        }
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(LifeCycleUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) LifeCycleUtils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                if (aom != null) {
                    if (aom.checkOpNoThrow(AppOpsManager.OPSTR_GET_USAGE_STATS,
                            info.uid,
                            info.packageName) != AppOpsManager.MODE_ALLOWED) {
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        LifeCycleUtils.getApp().startActivity(intent);
                    }
                    if (aom.checkOpNoThrow(AppOpsManager.OPSTR_GET_USAGE_STATS,
                            info.uid,
                            info.packageName) != AppOpsManager.MODE_ALLOWED) {
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) LifeCycleUtils.getApp()
