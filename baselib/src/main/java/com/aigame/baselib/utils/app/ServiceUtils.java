...
public final class ServiceUtils {
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(LifeCycleUtils.getApp(), cls);
        LifeCycleUtils.getApp().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(LifeCycleUtils.getApp(), cls);
        return LifeCycleUtils.getApp().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(LifeCycleUtils.getApp(), cls);
        LifeCycleUtils.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        LifeCycleUtils.getApp().unbindService(conn);
    }
