...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (LifeCycleUtils.getApp().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, LifeCycleUtils.getApp().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = LifeCycleUtils.getApp().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = LifeCycleUtils.getApp().getResources();
