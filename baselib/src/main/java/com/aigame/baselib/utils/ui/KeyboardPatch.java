...
import com.aigame.baselib.utils.bar.ImmersionBar;
            ...
            if (diff > 0) {
                if (mContentView.getPaddingBottom() != diff) {
                    if (flag || (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && !OSUtils.isEMUI3_1())) {
                        ...
                        mContentView.setPadding(0, 0, 0, diff + ImmersionBar.getNavigationBarHeight());
                    }
                }
            } else {
                if (mContentView.getPaddingBottom() != 0) {
                    if (flag || (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && !OSUtils.isEMUI3_1())) {
                        ...
                        mContentView.setPadding(0, 0, 0, ImmersionBar.getNavigationBarHeight());
                    }
                }
            }
        }
