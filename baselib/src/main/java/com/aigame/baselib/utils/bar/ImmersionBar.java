package com.aigame.baselib.utils.bar;
...
import com.aigame.baselib.utils.device.OSUtils;
import com.aigame.baselib.utils.ui.KeyboardPatch;
...
public class ImmersionBar {
    ...
    private static BarConfig mConfig;
     ...
     */
    public void toggleStatusBar(boolean isDark) {
    ...
    private int hideBar(int uiFlags) {
        ...
        return uiFlags | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN;
    }
    ...
    private void transformView() {
        if (mBarParams.viewMap.size() != 0) {
            ...
            for (Map.Entry<View, Map<Integer, Integer>> entry : entrySet) {
                ...
                if (view != null) {
                    if (Math.abs(mBarParams.viewAlpha - 0.0f) <= 1e-6) {
    ...
    public static boolean hasNavigationBar() {
        return mConfig.hasNavigtionBar();
    }
    ...
    public static int getNavigationBarWidth(Activity activity) {
        return mConfig.getNavigationBarWidth();
    }
    ...
    public static boolean isNavigationAtBottom(Activity activity) {
        return mConfig.isNavigationAtBottom();
    }
    ...
    public static int getActionBarHeight(Activity activity) {
        return mConfig.getActionBarHeight();
    }
