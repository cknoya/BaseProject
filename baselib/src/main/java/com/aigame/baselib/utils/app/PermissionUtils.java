...
import com.aigame.baselib.constance.PermissionConstants;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(LifeCycleUtils.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(LifeCycleUtils.getApp(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + LifeCycleUtils.getApp().getPackageName()));
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(LifeCycleUtils.getApp());
    }
