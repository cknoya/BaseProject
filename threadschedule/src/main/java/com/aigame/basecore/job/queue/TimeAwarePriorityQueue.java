package com.aigame.basecore.job.queue;

import java.util.Collection;
import java.util.Comparator;
import java.util.PriorityQueue;

import com.aigame.basecore.job.comparator.ConsistentTimedComparator;
import com.aigame.basecore.job.comparator.TimeAwareComparator;
import com.aigame.basecore.job.handler.JobHolder;
import com.aigame.basecore.job.helper.CountWithGroupIdsResult;
import com.aigame.basecore.job.jobs.JobSet;
import com.aigame.basecore.job.jobs.NonPersistentJobSet;
import com.aigame.basecore.job.queue.MergedQueue.SetId;
